            ...
            <main className='dashboard-contain'>
                ...
                <section>
                    <div className="table">
                        ...
                        <Link to="/admin-dashboard/create" className='create'><button className='btn secondary' ><i class="fas fa-plus"></i> Create New Data Row</button></Link>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><Link to="/admin-dashboard/edit" title="Edit" ><i class="fas fa-edit"></i></Link></td>
                                <td><a className='delete' title="Delete"><i class="fas fa-trash"></i></a></td>
                            </tr>
                            <tr>
                                <td>AD</td>
                                ...
                                <td></td>
                                <td>No Values Included</td>
                                <td><Link to="/admin-dashboard/edit"><i class="fas fa-edit"></i></Link></td>
                                <td><a className='delete'><i class="fas fa-trash"></i></a></td>                                
                            </tr>
                            <tr>
                                <td>BS</td>
